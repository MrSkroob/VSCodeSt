...
class Simulation:
  def __init__(self):
    ...
    Choice = input("Enter L for a large settlement, anything else for a normal size settlement: ").lower()
    if Choice == "l":
    ...
    Choice = input("Enter D for default companies, anything else to add your own start companies: ").lower()
    if Choice == "d":
